...
//     if (savedPrice) {
//       updateItemPrice(item.id, parseFloat(savedPrice));
//     }
//     // We don't need to update the image in context, it's handled in the component
//     // Just make sure that the correct image is displayed based on the saved state
//   }, [item.id, updateItemPrice]);
